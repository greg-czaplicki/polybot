...
`src/server/pipeline/pick-enrichment-helpers.ts:240` — dimension: data-integrity — **status: open**
...
`src/server/pipeline/pick-enrichment-helpers.ts:258` — dimension: scoring — **status: open**
...
`src/server/pipeline/pick-enrichment-helpers.ts:240` — dimension: book-anchor — **status: open**
