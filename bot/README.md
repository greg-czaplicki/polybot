...
- Set env vars:
  ...
  - `BOT_WINDOW_MINUTES` (default 60, candidate API window)
  - `BOT_MIN_MINUTES_TO_START` (default 15, hard lower timing gate)
  - `BOT_MAX_MINUTES_TO_START` (default 60, hard upper timing gate)
  - `BOT_POLL_SECONDS` (default 20)
  - `BOT_REQUIRE_MICROSTRUCTURE` (default true, enforce quality threshold)
  - `BOT_MARKET_QUALITY_THRESHOLD` (default 0.72)
  ...
  - `BOT_L2_IMBALANCE_NEAR_MID_THRESHOLD` (default -0.10)
  - `BOT_FALLBACK_NO_L2_STAKE_MULTIPLIER` (default 0.5, stake multiplier when L2 missing and skipping is disabled)
